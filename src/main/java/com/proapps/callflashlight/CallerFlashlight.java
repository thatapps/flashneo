package com.proapps.callflashlight;
...
public class CallerFlashlight extends Application implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        private int callFlashOnDuration = 200, callFlashOffDuration = 250, msgFlashOnDuration = 200, msgFlashOffDuration = 250, msgFlashDuration = 3;
        ...
        public void registerVolumeButtonReceiver() {
                ...
                try {
                        ...
                        mediaButtonReceiver = new MediaButtonReceiver(0);
        ...
        public int getCallFlashOffDuration() {
                //                callFlashOffDuration = prefs.getInt("callFlashOffDuration", 200);
